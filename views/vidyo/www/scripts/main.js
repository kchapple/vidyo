...
// Toggle Icon code
var img_camera_array= new Array( url_baseUrl + '/images/camera_privacy.png', url_baseUrl + '/images/camera.png');
var img_mic_array= new Array( url_baseUrl + '/images/mic_mute.png', url_baseUrl + '/images/mic.png');
var img_speaker_array= new Array( url_baseUrl + '/images/speaker_mute.png', url_baseUrl + '/images/speaker.png');
var count_camera=-1;
var count_mic=-1;
var count_speaker=-1;
...
var sendSoapUserRequest = function (action, body, portalAddr, username, password) {
    log('info', 'soap', 'sendSoapUserRequest(', (action || ""), (body || ""), ')');
...
var bodyLoaded = function () {
    ...
    // }else{
        ...
        var scripts = [
            url_baseUrl + '/scripts/vidyo/proxywrapper.js',
            url_baseUrl + '/scripts/vidyo/vidyo.client2.js',
            url_baseUrl + '/scripts/utils/soap-proxy.js'
        ];
...
var parseDomArgs = function() {
    soapProxy         = document.getElementById("soapProxy").innerText;
    url_baseUrl       = document.getElementById("baseUrl").innerText;
    url_portalAddress = document.getElementById("portalAddress").innerText;
    url_user          = document.getElementById("username").innerText;
    url_pass          = document.getElementById("password").innerText;
    url_portalUri     = document.getElementById("portalUri").innerText;
    url_guestName     = document.getElementById("guestName").innerText;
