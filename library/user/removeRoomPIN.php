...
// prepare remove room pin
$removeRoomPINParam = array('roomID' => $entityId);
try {
	$removeRoomPINResult = $client->removeRoomPIN($removeRoomPINParam);
	$removeRoomPINResult = $removeRoomPINResult->OK;
	echo "Remove Room PIN result is $removeRoomPINResult<br><br>";
} catch (SoapFault $e){
