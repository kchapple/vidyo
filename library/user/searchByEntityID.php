...
// prepare search
$searchByEntityIDParam = array('entityID' => $entityID, 'Filter' => '');
$c = 1;
try {
	$searchResult = $client->searchByEntityID($searchByEntityIDParam);
	echo "The number of returned entities is $searchResult->total<br><br>";
