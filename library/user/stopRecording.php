...
// prepare stopRecording
$stopRecordingParam = array();

$conferenceID = $_GET['conferenceID'];
$stopRecordingParam['conferenceID'] = $conferenceID;
$recorderID = $_GET['recorderID'];
$stopRecordingParam['recorderID'] = $recorderID;

if( $moderatorPIN = $_GET['moderatorPIN'] )
	$stopRecordingParam['moderatorPIN'] = $moderatorPIN;

try {
	$stopRecordingResult = $client->stopRecording($stopRecordingParam);
	if ($stopRecordingResult->OK)
	    echo "Recording stoped successfully<br><br>";
