...
// prepare Add To My Contacts
if( $add_entityID = $_GET['add_entityID'] ) {
	$addToMyContactsParam = array('entityID' => $add_entityID);
	try {
		$addToMyContactsResult = $client->addToMyContacts($addToMyContactsParam);
		$addToMyContactsResult = $addToMyContactsResult->OK;
		echo "Add To My Contacts result is $addToMyContactsResult<br><br>";
	} catch (SoapFault $e){
