...
// prepare resumeRecording
$resumeRecordingParam = array();

$conferenceID = $_GET['conferenceID'];
$resumeRecordingParam['conferenceID'] = $conferenceID;
$recorderID = $_GET['recorderID'];
$resumeRecordingParam['recorderID'] = $recorderID;

if( $moderatorPIN = $_GET['moderatorPIN'] )
	$resumeRecordingParam['moderatorPIN'] = $moderatorPIN;

try {
	$resumeRecordingResult = $client->resumeRecording($resumeRecordingParam);
	if ($resumeRecordingResult->OK)
	    echo "Recording resumed successfully<br><br>";
