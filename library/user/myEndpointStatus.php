...
// prepare My Endpoint Status
try {
	$myEndpointStatusResult = $client->myEndpointStatus();
	$myEndpointStatusResult = $myEndpointStatusResult->MemberStatus;
	echo "My Endpoint Status is $myEndpointStatusResult<br><br>";
} catch (SoapFault $e){
