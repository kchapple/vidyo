...
// prepare update language
if( $Language = $_GET['Language'] ) {
	$updateLanguageParam = array('Language' => $Language);
	try {
		$updateLanguageResult = $client->updateLanguage($updateLanguageParam);
		$updateLanguageResult = $updateLanguageResult->OK;
		echo "Update Language result is $updateLanguageResult<br><br>";
	} catch (SoapFault $e){
