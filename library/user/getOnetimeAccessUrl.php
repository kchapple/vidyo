...
try {
	$getOnetimeAccessUrlResult = $client->getOnetimeAccessUrl();
	echo "Your one-time Access URL is:<br>$getOnetimeAccessUrlResult->url<br>";
    echo "<a href=\"$getOnetimeAccessUrlResult->url\" target=\"_blank\">Click Here To Open</a><br><br>";
	echo "<br>";
