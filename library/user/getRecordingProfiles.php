...
try {
	$getRecordingProfilesResult = $client->getRecordingProfiles();
	echo "The number of recording profiles is $getRecordingProfilesResult->total<br><br>";
	if ($getRecordingProfilesResult->total > 0) {
	   echo "<table>";
           echo "<tr><td>recorderPrefix</td><td>description</td></tr>";
	   foreach ($getRecordingProfilesResult->recorder as $recorder){
	    echo "<tr><td>$recorder->recorderPrefix</td><td>$recorder->description</td></tr>";
	   }
           echo "</table>";
	}
	echo "<br>";
