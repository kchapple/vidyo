...
// prepare remove room url
$removeRoomURLParam = array('roomID' => $entityId);
try {
	$removeRoomURLResult = $client->removeRoomURL($removeRoomURLParam);
	$removeRoomURLResult = $removeRoomURLResult->OK;
	echo "Remove Room URL result is $removeRoomURLResult<br><br>";
} catch (SoapFault $e){
