...
class vu2vusoap {
	...
	public function __construct( $vu2vu_username, $vu2vu_password, $vu2vu_wsdl_url )
    {
        $this->setUsername($vu2vu_username);
        $this->setPassword($vu2vu_password);
        $this->setWsdlUrl($vu2vu_wsdl_url);
    }
